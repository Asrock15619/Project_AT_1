...
class Anup():
    ...
    def pim(self):
        ...
        sleep(5)
        self.driver.find_element(by=By.XPATH,value=locator.Anup.edit).click()
        sleep(5)
        self.driver.find_element(by=By.XPATH, value=locator.Anup.employee).send_keys(data.Anup.id)
        sleep(5)
